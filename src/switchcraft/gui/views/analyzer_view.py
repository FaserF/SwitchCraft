...
class AnalyzerView(ctk.CTkFrame):
    ...
    def _show_results(self, info, winget_url, brute_force_data=None, nested_data=None, silent_disabled=None):
        ...
        if winget_url:
            ...
            w_lbl.pack(pady=5)
            ctk.CTkButton(winget_panel, text=i18n.get("view_winget"), fg_color="transparent", border_width=1, command=lambda: webbrowser.open(winget_url)).pack(pady=5, padx=10, fill="x")
        else:
