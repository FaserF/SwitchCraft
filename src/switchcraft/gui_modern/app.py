    ...
    def _first_run_setup(self):
        ...
        dlg = ft.AlertDialog(
            ...
            actions=[
                ...
                ft.FilledButton(content=ft.Text("Install Essential"), on_click=start_setup)
            ],
            modal=True,
        )
        self.page.open(dlg)
                ...
                def show_error():
                    ...
                    dlg = ft.AlertDialog(
                        ...
                        actions=[
                            ...
                            ft.FilledButton(content=ft.Text("Open Download Page"), on_click=open_download, bgcolor="BLUE_700", color="WHITE"),
                        ]
                    )
                    self.page.open(dlg)
