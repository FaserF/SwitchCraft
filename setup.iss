...
AppComments=The Ultimate Silent Switch Finder
...
; Optional: Link to GitHub (checked by default)
Filename: "{#MyAppURL}"; Description: "Star us on GitHub"; Flags: postinstall shellexec; Check: WizardSilent = False
